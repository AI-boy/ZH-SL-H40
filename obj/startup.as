	...
	; Compiler options:
	;
	; -oZH-SL-H40.cof -mZH-SL-H40.map --summary=default --output=default \
	; adc.p1 delay.p1 interrupt.p1 ird_remote.p1 key.p1 led.p1 main.p1 \
	; Modbus.p1 PID.p1 pwm.p1 task.p1 timer.p1 uart.p1 --chip=16F1938 \
	; -ID:\MCUProject\ZH-SL-H40\include \
	; -ID:\Program Files (x86)\Microchip\xc8\v1.30\include -P \
...
;Stack space: 02280h-0231Fh (160 bytes)
...
;	WDTE = NSLEEP, WDT enabled while running and disabled in Sleep
